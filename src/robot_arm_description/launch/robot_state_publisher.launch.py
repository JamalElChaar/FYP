#!/usr/bin/env python3
"""
Launch RViz visualization for the robot_arm.

This launch file sets up the complete visualization environment for the robot_arm,
...
def process_ros2_controllers_config(context):
    ...
    try:
        ...
        # Template file doesn't exist, skip processing
        pass
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='robot_arm',
    ...
    DeclareLaunchArgument('base_type', default_value='fixed',
                          description='Type of the base'),
    DeclareLaunchArgument('flange_link', default_value='link_6',
                          description='Name of the flange link'),
    DeclareLaunchArgument('use_camera', default_value='false',
                          choices=['true', 'false'],
                          description='Whether to use the RGBD camera'),
...
def generate_launch_description():
    """Generate the launch description for the robot_arm visualization.

    This function sets up all necessary nodes and parameters for visualizing
    the robot_arm in RViz, including:
